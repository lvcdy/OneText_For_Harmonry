...
class AboutActivity : BaseActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        storage_isolation_imageview.setOnClickListener { startActivity(Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/RikkaApps/StorageRedirect-assets/blob/master/app_rule/apps/cn.lvcdy.onetext.json"))) }
        googleplay_imageview.setOnClickListener { startActivity(Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=cn.lvcdy.onetext"))) }
        coolapk_imageview.setOnClickListener { startActivity(Intent(Intent.ACTION_VIEW, Uri.parse("https://coolapk.com/apk/cn.lvcdy.onetext"))) }
