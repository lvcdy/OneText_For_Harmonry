...
import cn.lvcdy.onetext.tools.feed.Feed;
import cn.lvcdy.onetext.tools.feed.FeedAdapter;
...
public class SettingActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerReceiver(receiver, new IntentFilter("cn.lvcdy.onetext.updatefeedlist"));
        registerReceiver(receiver, new IntentFilter("cn.lvcdy.onetext.issettingupdated"));
        ...
        widget_dark_switch.setOnCheckedChangeListener((buttonView, isChecked) -> {
            ...
            editor.commit();
            Intent intent12 = new Intent("cn.lvcdy.onetext.widget");
        ...
        widget_shadow_switch.setOnCheckedChangeListener((buttonView, isChecked) -> {
            ...
            editor.commit();
            Intent intent13 = new Intent("cn.lvcdy.onetext.widget");
        ...
        widget_center_switch.setOnCheckedChangeListener((buttonView, isChecked) -> {
            ...
            editor.commit();
            Intent intent14 = new Intent("cn.lvcdy.onetext.widget");
    ...
    class Receiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals("cn.lvcdy.onetext.updatefeedlist")) {
                initFeed();
            }
            if (intent.getAction().equals("cn.lvcdy.onetext.issettingupdated")) {
