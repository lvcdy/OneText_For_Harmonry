...
import cn.lvcdy.onetext.fragment.WelcomeFragment0;
import cn.lvcdy.onetext.fragment.WelcomeFragment1;
import cn.lvcdy.onetext.fragment.WelcomeFragment2;
import cn.lvcdy.onetext.fragment.WelcomeFragment3;
import cn.lvcdy.onetext.fragment.WelcomeFragment4;
import cn.lvcdy.onetext.fragment.WelcomeFragment5;
...
public class WelcomeActivity extends BaseActivity implements EasyPermissions.PermissionCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerReceiver(receiver, new IntentFilter("cn.lvcdy.onetext.requestpermission"));
    ...
    class Receiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals("cn.lvcdy.onetext.requestpermission")) {
