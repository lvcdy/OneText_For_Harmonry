package cn.lvcdy.onetext.service
...
import cn.lvcdy.onetext.OneTextApp
import cn.lvcdy.onetext.R
import cn.lvcdy.onetext.activity.MainActivity
...
class ExternalControlService : ControlsProviderService() {
    ...
    private fun buildOnetext(forceFresh: Boolean = false): Control {
        ...
        //更新小部件
        context.sendBroadcast(Intent("cn.lvcdy.onetext.widget").apply { setPackage(packageName) })
