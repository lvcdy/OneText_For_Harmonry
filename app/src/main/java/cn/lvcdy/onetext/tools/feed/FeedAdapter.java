package cn.lvcdy.onetext.tools.feed;
...
public class FeedAdapter extends RecyclerView.Adapter<FeedAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        holder.feedView.setOnClickListener(v -> {
            ...
            /*Intent intent = new Intent("cn.lvcdy.onetext.updatefeedlist");
        ...
        holder.feed_delete_textview.setOnClickListener(v -> {
            ...
            if (getItemCount() == 1) {
                ...
                /*Intent intent3 = new Intent("cn.lvcdy.onetext.issettingupdated");
